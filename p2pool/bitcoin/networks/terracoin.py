...
BLOCK_EXPLORER_URL_PREFIX = 'http://blockchain.terracoin.org/terracoin/blockhash/'
ADDRESS_EXPLORER_URL_PREFIX = 'http://blockchain.terracoin.org/terracoin/address/'
TX_EXPLORER_URL_PREFIX = 'http://blockchain.terracoin.org/terracoin/tx/'
