...
nets = dict(
    ...
    dogecoin=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://explorer.dogecoin.net/block/',
        ADDRESS_EXPLORER_URL_PREFIX='http://explorer.dogecoin.net/address/',
        TX_EXPLORER_URL_PREFIX='http://explorer.dogecoin.net/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8,
    ),
