...
nets = dict(
    ...
    giftcoin=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=9777,
        BOOTSTRAP_ADDRS='rav3n.dtdns.net p2pool.gotgeeks.com p2pool.dndns.net solidpool.org'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    ...
    lennycoin=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=9556,
        BOOTSTRAP_ADDRS='p2poo-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net p2pool.gotgeeks.com p2pool.dndns.net solidpool.org'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
