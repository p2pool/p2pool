...
echo "  ./src/dogecoind -testnet4alpha -datadir=~/.dogecoin-testnet4alpha -server -rpcuser=dogeuser -rpcpassword=YOUR_DOGE_RPC_PASSWORD"
echo ""
echo "To connect from RPC:"
echo "  ./src/dogecoin-cli -testnet4alpha -rpcport=44559 -rpcuser=dogeuser -rpcpassword=YOUR_DOGE_RPC_PASSWORD getblockchaininfo"
echo ""
